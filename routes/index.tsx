    ...
    <section class="p-4 flex justify-evenly items-center flex-wrap">
      <div class="max-w-sm mt-8">
        ...
        <p class="text-xl mt-4">
          I build web applications and websites using modern technologies, with
          experience in data analysis and transforming data into meaningful
          insights.
        </p>
      </div>
      <SpinningModel />
    ...
    <section class="p-4 my-8">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div>
          ...
          />
          <p class="mt-2 text-center text-sm">Visualization of Arms Trade</p>
        </div>
        <div>
          <img
        ...
        <div>
          <img
            ...
            class="w-full rounded"
          />
          <p class="mt-2 text-center text-sm">Pakistan Stock Exchange</p>
        </div>
      </div>
    </section>
  );
    ...
    <section class="my-16">
      ...
      <div class="p-4 flex justify-center items-center flex-wrap gap-4">
        {technologies.map((technology) => (
          <Icon class="w-8 h-8" icon={technology} width="none" height="none" />
        ))}
      </div>
    </section>
  );
